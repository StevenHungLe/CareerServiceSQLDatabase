...
public class course {
	...
	public boolean deleteCourseDetails(int courseId) {
	 ...
	 public static void main(String[] args){
		 ...
		 //c1.AddCourseDetails(697, "SOmetitle", "Somelevel", "SomeDescription", "status", 450.55);
		// c1.AddSkillToCourse(697, 565);
		 //c1.AddSkillToCourse(697, 564);
		 c1.deleteCourseDetails(697);
